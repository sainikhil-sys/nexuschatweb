...
urlpatterns = [
    ...
    path('<int:conversation_id>/send-http/', views.send_message_http, name='send_http'),
    path('<int:conversation_id>/messages-http/', views.get_messages_http, name='messages_http'),
